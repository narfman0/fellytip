...
| `tools/sprite_gen` | AI sprite-sheet generator: reads `assets/bestiary.toml`, calls mock or DALL-E 3 backend, writes atlas PNGs + JSON manifests to `crates/client/assets/sprites/` |
